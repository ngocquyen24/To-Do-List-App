                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            ...
                            <td class="px-2 py-4"><img class="img-fluid" style="height: 50px;   width: 50px; border-radius: 50%;" src="{{asset('avatars/'.$user->avatar.'')}}" alt=""></td>


                            </div>
                            <ul class="dropdown-menu">

                                <li><a class="dropdown-item border-bottom" href="{{route('user.index')}}">  profile</a></li>
