    ...
    <div class="row mx-1 px-5 pb-3 w-80">
        <div class="col mx-auto">
            ...
            <div class=" px-3 align-items-center todo-item rounded d-flex">
                ...
                <div class="align-items-center" style="width: 29%">
                <h5 class="m-0 p-0 px-2">

                    Name
                </h5>
                </div>
                <div class="align-items-center " style="width: 28%">
                <h5 class="m-0 p-0 px-2 d-none d-sm-block">
                ...
                <div class="mt-3  todo-actions display:flex">
                    <div class="row d-flex align-items-center justify-content-end d-none d-sm-block">
                        <h5 class="">
        ...
        @foreach($tasks as $task)
            ...
            <div class="row px-3 align-items-center todo-item rounded">
                ...
                <!-- <td>{{ $loop->iteration }}</td> -->
                    ...
                    <input type="text" class="form-control form-control-lg border-0 edit-todo-input rounded px-2 d-none d-sm-block" readonly value="{{$task->task_details}}" />
                    <input type="text" class="form-control form-control-lg border-0 edit-todo-input rounded px-2 " readonly value="{{$task->status}}" />
                ...
                <div class="col-auto m-1 p-0 todo-actions display:flex">
                    ...
                    <div class="col-auto d-flex  rounded bg-white border border-warning">
                            ...
                            <h6 class="text my-2 pr-2">{{date('d-M-y', strtotime($task->created_at))}}</h6>
